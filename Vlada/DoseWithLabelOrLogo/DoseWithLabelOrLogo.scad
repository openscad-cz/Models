...
/* [Printing] */
// Print two separate parts or assembly
...
{
translate([0,0,0.001])    
resize([Breite_Dose*scale, 0, 0], true)
rotate([180, 0, 0])    
...
translate([0,0,0.001])      
rotate([180, 0, 0])
linear_extrude(10, convexity = 10) {text(label, font = font , size = size, valign = "center", halign = "center", spacing = spacing);}
}
